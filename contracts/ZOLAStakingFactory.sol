...
import './ZOLAStakingPoolInitializable.sol';

contract ZOLAStakingFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(ZOLAStakingPoolInitializable).creationCode;
        ...
        ZOLAStakingPoolInitializable(sousChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerSecond,
            _startTimestamp,
