...
import "./AstroStakingPoolInitializable.sol";

contract AstroStakingFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(AstroStakingPoolInitializable)
            .creationCode;
        ...
        AstroStakingPoolInitializable(sousChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerSecond,
            _startTimestamp,
